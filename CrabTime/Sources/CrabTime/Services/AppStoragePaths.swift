...
struct AppStoragePaths: Equatable, Sendable {
    ...
    static func live(fileManager: FileManager = .default) -> AppStoragePaths {
        ...
        let baseURL = appSupportURL.appendingPathComponent(AppBrand.applicationSupportDirectoryName, isDirectory: true)
        let legacyBaseURL = appSupportURL.appendingPathComponent(AppBrand.legacyApplicationSupportDirectoryName, isDirectory: true)
