    ...
    var body: some View {
        VStack(spacing: 24) {
            ...
            VStack(spacing: 8) {
                ...
                Text("\(AppBrand.longName) needs some system tools to function properly.")
                    .font(.body)
            ...
            VStack(alignment: .leading, spacing: 16) {
                ...
                case .missing(let needsRust, let needsExercism):
                    ...
                    .padding()
                    .background(CrabTimeTheme.Palette.panelTint.opacity(0.1))
                    .cornerRadius(CrabTimeTheme.Layout.subpanelRadius)
                    ...
                    Button(action: onInstall) {
                        Text("Install Missing Tools")
                            ...
                            .padding(.vertical, 12)
                            .background(CrabTimeTheme.Palette.panelTint)
                            .cornerRadius(CrabTimeTheme.Layout.cornerRadius)
                    }
                    .buttonStyle(.plain)
                    .interactivePointer()
    ...
    var body: some View {
        HStack(spacing: 12) {
            ...
            Text("Missing")
                ...
                .padding(.vertical, 4)
                .background(CrabTimeTheme.Palette.ember.opacity(0.12))
                .cornerRadius(4)
        }
    }
}
